//
//  KeychainItem.swift.swift
//  Covid19iOSCharts
//
//  Created by Ben Huggins on 2/7/22.
//
...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.checklists.GetData-", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.checklists.GetData-", account: "userIdentifier").deleteItem()
        } catch {
